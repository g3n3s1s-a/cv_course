...
while(cap.isOpened()):
    ...
    lower_hsv = np.array([40, 50, 100])   # Lower H, S, and especially V
    upper_hsv = np.array([80, 255, 255])  # Higher H and max out S and V
    #lower_hsv = np.array([50,90,165])
    #upper_hsv = np.array([60,115,180])
